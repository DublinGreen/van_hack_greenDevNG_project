										...
										<div class="uni-sticker-label">
											<div class="label-info">
												<a href="#">
													...
													<span class="label-title"><?php echo($this->session->userdata('username')); ?> edit topics</span>
												</a>
											</div>
										</div>
										<?php
									...
									?>
											...
											<div class="col-md-12 home-post-text"><br>
											  <?php
												...
												<form action="<?php echo(base_url()  . "index.php/welcome/editTopics/{$post->id}/{$post->category}"); ?>" method="post" id="commentform" class="comment-form">
                                                    <div class="row">
                                                        <div class="comment-form-author form-group col-md-6">
															<span class="lable">Title:</span> 
                                                            <input required="" placeholder="Title*"  name="title" type="text" value="<?php echo($post->title); ?>" class="form-control">
                                                        </div>
														...
														<div class="comment-form-comment form-group col-md-12">
                                                            ...
                                                            <textarea required="" placeholder="Content.." name="content" class="form-control"><?php echo($post->content); ?></textarea>
                                                        </div>
                                                        <div class="form-submit form-group col-md-12">
                                                            <input name="submit" type="submit" class="btn btn-primary" value="Edit Topic">
                                                        </div>
                                                    </div>
                                                </form>
												<br><hr><br>
